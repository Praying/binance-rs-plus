...
mod tests {
    ...
    fn to_i64() {
        ...
        assert_eq!(binance_rs_plus::util::to_i64(&value_max), i64::MAX);
        assert_eq!(binance_rs_plus::util::to_i64(&value_min), i64::MIN);
    }
    ...
    fn to_f64() {
        ...
        assert!(approx_eq!(
            f64,
            binance_rs_plus::util::to_f64(&value),
            123.3,
            ulps = 2
        ));
    }
